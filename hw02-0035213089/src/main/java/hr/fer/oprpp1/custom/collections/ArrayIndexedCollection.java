...
//    }
    ...
    public void addAll(Collection other) {
        ArrayIndexedCollection col = (ArrayIndexedCollection) other;
    ...
    private static class arrayIndexedElementsGetter implements ElementsGetter {
         ...
         */
        public arrayIndexedElementsGetter(ArrayIndexedCollection other, long modificationCount) {
            this.list = other;
        ...
        public Object getNextElement() {
            ...
            Object obj = this.list.elements[j];
            if(obj != null) {
                if(j < this.list.size) {
                    j++;
                }
