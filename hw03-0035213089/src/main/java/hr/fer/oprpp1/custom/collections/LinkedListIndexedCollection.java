...
public class LinkedListIndexedCollection<E> implements List<E> {
    ...
    public void addAll(Collection<? extends E> other) {
        LinkedListIndexedCollection<E> collection = new LinkedListIndexedCollection<>(other);
...
//    }
    ...
    private static class linkedListIndexedElementsGetter<E> implements ElementsGetter<E> {
         ...
         */
        public linkedListIndexedElementsGetter(LinkedListIndexedCollection<E> other, long modificationCount) {
            this.list = other;
    ...
    public ElementsGetter<E> createElementsGetter() {
        return new linkedListIndexedElementsGetter<E>(this, modificationCount);
    }
}
